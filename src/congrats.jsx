...
const CongratulationsModal = () => {
  ...
  {/* Background Effects */}
  <div 
    className="absolute top-0 right-0 w-96 h-96 opacity-30 sm:w-64 sm:h-64"
    style={{
  ...
  <div 
    className="absolute bottom-0 left-0 w-64 h-64 opacity-20 sm:w-48 sm:h-48"
    style={{
    ...
    >
      ...
      <div className="space-y-4 mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:space-x-3">
          ...
          {/* Referral Link */}
          <div 
            className="flex-1 relative rounded-xl p-4 cursor-pointer transition-all duration-200 hover:scale-105 mt-2 sm:mt-0"
        ...
        <button 
          ...
          style={{
            background: 'linear-gradient(135deg, #2563eb 0%, #113188ff 100%)',
